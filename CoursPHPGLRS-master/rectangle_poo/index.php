...
//Ouvrir session_start()
   ...
   ///session_destroy();
    ...
    if( isset($_POST['btn_submit'])){
       ...
       $validator=new Validator();//création objet

        $longueur=$_POST['longueur'];
        $largeur=$_POST['largeur'];

//1)Si longueur vide et il y a erreur dans Largeur seulement l'erreur vide de Longueur s'affiche =>errors['Longueur']
//2)Si largeur vide et il y a erreur dans Longueur seulement l'erreur vide de Largeur s'affiche =>errors['Largeur']
//3)Si longueur a l'erreur"Veuiller saisir un nombre" et si il y a erreur dans Largeur(negatif) seulement l'erreur de Longueur s'affiche
//=>errors['Longueur']

          $validator->is_positif($longueur,'longueur');//count($errors)=1
          $validator->is_positif($largeur,'largeur');//aaaaa
